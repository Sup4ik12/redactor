...
int main()
{
    ...
    btn[1] = {350,30,"ФРУКТОВНИЦЫ",TX_GREY,"ФРУКТОВНИЦЫ"};
    btn[2] = {600,30,"ФРУКТЫ",TX_GREY,"ФРУКТЫ"};
    btn[3] = {850,30,"ЯГОДЫ",TX_GREY,"ЯГОДЫ"};
    btn[4] = {1100,30,"БУЛОЧКИ",TX_GREY,"БУЛОЧКИ"};
    btn[5] = {1350,30,"ЦВЕТЫ",TX_GREY,"ЦВЕТЫ"};

    pic Mp[countMp];
    Mp[0] = {0,100,120,120,700,700,txLoadImage("картинки\\вазы\\ваза1.bmp"),false,"ВАЗЫ"};
    Mp[1] = {0,220,120,120,700,700,txLoadImage("картинки\\вазы\\ваза2.bmp"),false,"ВАЗЫ"};
    Mp[2] = {0,340,120,120,700,700,txLoadImage("картинки\\вазы\\ваза3.bmp"),false,"ВАЗЫ"};

    Mp[3] = {0,100,120,120,500,500,txLoadImage("картинки\\фруктовница\\фрукт1.bmp"),false,"ФРУКТОВНИЦЫ"};
    Mp[4] = {0,220,120,120,500,500,txLoadImage("картинки\\фруктовница\\фрукт2.bmp"),false,"ФРУКТОВНИЦЫ"};
    Mp[5] = {0,340,120,120,500,500,txLoadImage("картинки\\фруктовница\\фрукт3.bmp"),false,"ФРУКТОВНИЦЫ"};

    Mp[6] = {0,100,120,120,200,266,txLoadImage("картинки\\цветы\\цветок1.bmp"),false,"ЦВЕТЫ"};
    Mp[7] = {0,220,120,120,200,266,txLoadImage("картинки\\цветы\\цветок2.bmp"),false,"ЦВЕТЫ"};
    Mp[8] = {0,340,120,120,200,266,txLoadImage("картинки\\цветы\\цветок3.bmp"),false,"ЦВЕТЫ"};

    Mp[9] = {0,100,120,120,150,150,txLoadImage("картинки\\фрукты\\фрукт1.bmp"),false,"ФРУКТЫ"};
    Mp[10] = {0,220,120,120,150,150,txLoadImage("картинки\\фрукты\\фрукт2.bmp"),false,"ФРУКТЫ"};
    Mp[11] = {0,340,120,120,150,150,txLoadImage("картинки\\фрукты\\фрукт3.bmp"),false,"ФРУКТЫ"};
